...
export const metadata: Metadata = publicMetadata({
  title: "Company News",
  description:
    "LifeSupply Health company announcements with their dates and sources, the historical 2022 releases, and practical resources with a named author and reviewer.",
  path: "/news/",
});
