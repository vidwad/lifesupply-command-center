...
| `graphics/pharmacy/injection-accessories-greyscale-v1.jpg`, `supply-organization-greyscale-v1.jpg` | `graphics.ts` `pharmacyInjection`, `pharmacyOrganization` | Pharmacy Solutions, two of the six representative-supplies tiles (the other four reuse `categoryMonitoring`, `metabolicSupplies`, `categoryInjection`, `clinicSupplies`) | Registry alt, beginning "Conceptual" | Gamma photo mode, 2026-09-13 (S-182, S-183), monochrome brief, neutral greyscale at 1600×900; no person, logo or packaging text; never a specific product offered for sale |
