...
| Connected Care diagram | `connected-care/*.tsx` | Connected Care Vision, "Connected care, built around patient needs." | Real text throughout: the hub, four node cards with written statuses, relationship lines, native disclosures and the four capabilities; the SVG connectors are decorative and hidden | Typeset in tokens from one configuration in `content/connected-care.ts`; three layouts by container width; connectors measured from the cards. Six hand-drawn 24px icons at a 1.5 stroke. Added 2026-09-13; no image file |
...
| `graphics/connected-care/consultation-desk-greyscale-v1.jpg` | `graphics.ts` `connectedCareDesk` | Connected Care Vision hero backdrop | Decorative backdrop; the heading carries the meaning | Gamma photo mode, 2026-09-13 (S-184), monochrome brief, neutral greyscale at 1600×900; a consultation desk, deliberately not a laboratory or vials; no person, logo or text |
| `graphics/investors/expansion-cover.jpg` | `graphics.ts` `expansionCover` | Investors, financial-information section, below the annual-report text | Registry alt, beginning "Conceptual" | Rendering of the expansion-strategy document's cover supplied by the product owner on 2026-09-14 (S-185), resized to 800 px wide; shows the title, the date and the three approved operating figures, nothing from inside the document |
| `graphics/home/supply-hall-greyscale-v1.jpg` | `graphics.ts` `homeSupplyHall` | Registered 2026-09-14 for "Who are we and what we do"; unpublished the same day when the owner chose the prior site's clip | Registry alt, beginning "Conceptual" | Gamma photo mode, 2026-09-14 (S-186), monochrome brief, neutral greyscale at 1600×900; a fulfilment aisle with scale, replacing `suppliesAndPlans` here (which stays on the Contact page); no person, logo or text |
...
| `video/home-intro.webm`, `home-intro.mp4`, `home-intro-poster.jpg` | `content/home.ts` `whoWeDoVideo` | Home, "Who are we and what we do", the right column | Decorative; hidden from assistive technology; poster for reduced motion | The prior lifesupplyhealth.com home-page video (wp-content/uploads/2021/10/LSHomeVid.mp4), cut to its first fourteen seconds at the product owner's direction on 2026-09-14 so it plays once on load and stops; 1280 wide, silent (S-187). The footage carries the prior site's own captions, recorded here and not treated as published copy |
