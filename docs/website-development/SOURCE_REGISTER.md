...
| S-13 | Corporate name "LifeSupply Health Supplies Inc."; subsidiaries "Wellmart Health Supplies Ltd. DBA Lifesupply", "MedDirect Distribution Corporation", "Dexton Medical Corporation" | `lifesupply-content.ts` `contact.subsidiaries`; legacy `/contact-2/` | A / H | Approved as already published; **U** whether MedDirect and Dexton remain operating entities today (WEB-01). |
...
| S-131 | Portfolio lockup (LifeSupply / Dexton / MEDdirect) | H | confirm active division status before extending (docs/40) |
