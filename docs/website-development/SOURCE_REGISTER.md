...
| S-158 | Divider photograph `legacy/about-data.jpg` (person with layered data displays) | O (prior site stock image `2021/10/lshome1.jpg`) | Copied 2026-09-09; cropped to 1920×1080, greyscale; decorative parallax divider, hidden from assistive technology; the person is the stock photograph's subject, never presented as staff |
