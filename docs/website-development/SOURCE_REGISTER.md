...
| S-160 | Diagram `diagrams/pharmacy-care-pathway.jpg` (hub-and-spoke: the supply platform connected to the pharmacy, the patient, clinic pathways, the group) | O (generated from the page's own copy) | Gamma AI infographic, hub layout, continuous line art, Rush theme, 2026-09-09; Gamma document kpl5it9m38lqbog; scaled to 1600×900; the text in the image repeats the four value cards beneath it, so it introduces no claim; registry `diagrams.ts` with its own test |
