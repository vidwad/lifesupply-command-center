...
| S-104 | Four portraits are bundled: Abdul Ladha, Keith Dolo, Barrett Sleeman, Dr. David Vogt | `public/lsh/` | A | Copied from the prior site on 2026-09-09 at the product owner's instruction (S-153 to S-155); no other portrait is held. |
...
| S-153 | Portrait `keith-dolo.jpg` (Keith Dolo, Director) | O (prior site `/wp-content/uploads/2021/10/keith.jpg`) | Copied 2026-09-09 at the product owner's instruction; scaled to 700×882 and held in greyscale; biography copied verbatim from `/keith-dolo-2/`, with a missing "and" restored in its last sentence |
| S-154 | Portrait `barrett-sleeman.jpg` (Barrett E.G. Sleeman, P.Eng., Director) | O (prior site `/wp-content/uploads/2021/05/Barret.png`) | Copied 2026-09-09; scaled to 700×882 from the greyscale original; biography copied verbatim from `/barrett-e-g-sleeman/` |
| S-155 | Portrait `david-vogt.jpg` (Dr. David Vogt, Director) | O (prior site `/wp-content/uploads/2021/11/David-Vogy-bw.jpg`) | Copied 2026-09-09; cropped to 700×882 from the greyscale original; biography copied verbatim from `/david-vogt/`, with a missing "a" restored in its first sentence |
| S-156 | Company video "Lifesupply Health: Who we are & What we do" (YouTube `Jb3m3Nt3S50`, LifeSupply channel) and its poster `video/about-abdul-ladha-poster.jpg` | O (published company video) | Embedded on the About page from 2026-09-09 at the product owner's instruction, starting at 12 s; the poster is the video's own title frame held locally in greyscale at 1280×720; the player loads from the privacy-enhanced host only when played, and the privacy page says so |
| S-157 | Divider photograph `legacy/about-desk.jpg` (hands writing at a desk) | O (prior site stock image `2021/08/about1.jpg`) | Copied 2026-09-09 at the product owner's instruction; cropped to 1920×1080, greyscale; decorative parallax divider behind the site's overlay colouring on the About page, hidden from assistive technology |
| S-158 | Divider photograph `legacy/about-data.jpg` (person with layered data displays) | O (prior site stock image `2021/10/lshome1.jpg`) | Copied 2026-09-09; cropped to 1920×1080, greyscale; the About hero's decorative backdrop beneath the hero scrim (product owner, later on 2026-09-09; first placed as a divider), hidden from assistive technology; the person is the stock photograph's subject, never presented as staff |
| S-159 | Divider photograph `legacy/about-warehouse.jpg` (racked pallets and a forklift) | O (prior site stock image `2021/07/ob3-1024x683-1.png`) | Copied 2026-09-09; upscaled and cropped to 1920×1080, greyscale; decorative parallax divider, hidden from assistive technology; not an owned facility. The prior page's growth-chart image (figures as pixels) and its three small card backgrounds were not carried over |
| S-160 | Care-pathway diagram on Pharmacy Solutions (hub-and-spoke: the supply platform connected to the pharmacy, the patient, clinic pathways, the group) | O (typeset from the page's own copy) | First shipped 2026-09-09 as a Gamma AI-infographic raster (document kpl5it9m38lqbog); replaced the same day, at the product owner's request for a considerably better diagram, by `care-pathway-diagram.tsx`, a typeset React component designed with Codex: real text from `pharmacy.ts`, tokens only, CSS connectors, semantic list; no image file is held |
| S-161 | Project photograph `graphics/projects/clinic-burnaby.jpg` (curved clinic reception, slatted timber front, matching ceiling feature) and the facts stated beside it: Medical clinic, Burnaby BC, 3,000 sq ft, built 2023 | O (LifeSupply Clinics project page `/portfolio/medical-clinic-construction-in-burnaby/`) | Copied 2026-09-11 from the project page published by the group's own clinic-development subsidiary; converted to neutral greyscale and scaled to 1600×900 with ffmpeg, no red treatment. Real photography of a real completed project, registered in `project-photography.ts`, which is separate from the conceptual `graphics.ts` and asserts the opposite: never described as conceptual, never showing a person. Clinic type, floor area and build year are quoted as that page publishes them |
| S-162 | Project photograph `graphics/projects/clinic-abbotsford.jpg` (clinic reprocessing room, stainless counters, autoclave, closed cabinetry) and the facts stated beside it: ENT clinic, Abbotsford BC, 3,000 sq ft, built 2022 | O (LifeSupply Clinics project page `/portfolio/ent-clinic-construction-in-abbotsford/`) | As S-161 |
| S-163 | Project photograph `graphics/projects/clinic-vancouver-medical.jpg` (clinic corridor across a reception counter, treatment-room doorways, supply trolleys in a recess) and the facts stated beside it: Medical clinic, Vancouver BC, 3,000 sq ft, built 2022 | O (LifeSupply Clinics project page `/portfolio/medical-clinic-design-build-in-vancouver/`) | As S-161 |
| S-164 | Published facts for the three clinic projects that carry no photograph: Oral surgery clinic, Squamish BC, 4,000 sq ft, 2024; Oral surgery clinic, White Rock BC, 4,000 sq ft, 2024; Allied health clinic, Vancouver BC, 2,000 sq ft, 2021 | O (the three LifeSupply Clinics project pages named in `content/clinics.ts`) | Verified against each page 2026-09-11. The Vancouver rehabilitation project is published as an "Allied Health Clinic" on a page titled "Physio clinic construction", and the published clinic type is what the site states. No scope, budget, client or endorsement is published for any of the six, and none is stated |
| S-165 | Conceptual graphic `news-desk.jpg` (folded newspaper, blank reports, folio, reading glasses on a dark desk) | A (generated) | Gamma photo mode, 2026-09-11, monochrome brief, ffmpeg neutral greyscale at 1600×900, no red treatment; commissioned for the hero backdrop pass because the existing set had nothing for News & Resources; conceptual, never presented as operational photography; decorative and hidden from assistive technology |
| S-167 | Conceptual graphic `graphics/medical-supplies/audience-home-greyscale-v1.jpg` (walking frame beside an armchair, blood-pressure monitor on a side table, daylit room) | A (generated) | Gamma photo mode, 2026-09-13, monochrome brief, ffmpeg neutral greyscale at 1600×900, no red treatment; the individuals-and-caregivers panel on Medical Supplies; conceptual, never operational photography; no person |
| S-168 | Conceptual graphic `graphics/medical-supplies/audience-clinic-greyscale-v1.jpg` (empty supply room: wire shelving with plain cartons and sealed packs, steel cart) | A (generated) | As S-167; the clinics-and-organizations panel. A generic room, never a LifeSupply premises, a customer's, or a project; blank cartons, no text |
| S-169 | Conceptual graphic `graphics/medical-supplies/category-bathroom-greyscale-v1.jpg` (grab bar and shower chair against a tiled wall) | A (generated) | As S-167; the Bathroom Safety & Home Care tile. Illustrates the category and is never a specific product for sale, which the page states beneath the explorer |
| S-170 | Conceptual graphic `graphics/medical-supplies/category-monitoring-greyscale-v1.jpg` (blood-pressure monitor and cuff, thermometer, glucose meter and vial; blank screens) | A (generated) | As S-169; the Monitoring & Diagnostics tile |
| S-171 | Conceptual graphic `graphics/medical-supplies/category-wound-greyscale-v1.jpg` (sealed dressing packs, gauze roll, adhesive strips) | A (generated) | As S-169; the Wound Care & First Aid tile |
| S-172 | Conceptual graphic `graphics/medical-supplies/category-clinic-dental-greyscale-v1.jpg` (steel tray with tissues, gauze, a sealed instrument pack, cotton rolls, paper cups) | A (generated) | As S-169; the Clinic & Dental Supplies tile; no treatment depicted |
| S-173 | Conceptual graphic `graphics/medical-supplies/category-injection-greyscale-v1.jpg` (blank cartons beside a sharps container) | A (generated) | As S-169; the Injection & Diabetes Supplies tile; no device, needle, or packaging text shown, so no compatibility is implied |
| S-174 | Conceptual graphic `graphics/medical-supplies/category-incontinence-greyscale-v1.jpg` (folded absorbent pads, plain carton, folded towel) | A (generated) | As S-169; the Incontinence & Ostomy Care tile |
| S-175 | Conceptual graphic `graphics/medical-supplies/category-respiratory-greyscale-v1.jpg` (compact nebulizer with tubing and mask on a bedside table) | A (generated) | As S-169; the Respiratory Care tile |
| S-176 | Brand marks in `public/lsh/logos/` (3M, Abbott, A&D Medical, Allison Medical, Attends, Avanos, B. Braun, Bard, Baxter, Bayer, BD, BSN Medical, Cardinal Health, Coloplast, Convatec, Covidien, DeRoyal, Drive DeVilbiss Healthcare, Dukal, Dynarex, GOJO, Graham-Field, Hollister, ICU Medical, Integra LifeSciences, Invacare, Jobst, Kimberly-Clark, Medline) | O (the brands directories of lifesupply.ca and wellmartmedical.com) | Copied 2026-09-13 from the brand image each store publishes on its own brands page; treated to greyscale with alpha and 96px tall with Pillow; registered in `supplier-logos.ts` with the store that lists each one. They show that the stores carry these brands, which the store pages state; they do not evidence a supply agreement, exclusivity, or endorsement, and the site never says so. Brands without a store-published logo (placeholder image) are not included |
| S-177 | Three isometric illustrations in `public/lsh/graphics/investors/` (store goods with a laptop; fulfilment box, hand truck and order-list tablet; examination room with floor plan) | A (supplied by the product owner) | Supplied 2026-09-13 for the operating-foundation columns of the investor page; served at supplied size as PNG through next/image; conceptual renders, not photographs; no person, real product, premises or order; registered in `graphics.ts` with the standard conceptual provenance |
| S-178 | `graphics/medical-supplies/supply-portal.jpg` (desktop monitor showing the illustrative portal concept) | A (supplied by the product owner) | Supplied 2026-09-13 for the portals section of Medical Supply Solutions; resized to 1500×1000 and saved as JPEG; the screen shows the page's own concept with its label and fictional data; conceptual, never a live product, account or order |
| S-187 | Video `video/home-intro.*` from the prior lifesupplyhealth.com home page (wp-content/uploads/2021/10/LSHomeVid.mp4), first fourteen seconds: a black open, a city aerial with the mark, an instrument flat-lay captioned "A smarter, faster, and more efficient way to shop", and a newspaper-and-laptop scene captioned "Life-improving products through innovative channels. This is the future of emerging technologies." | A (supplied, prior site) | Cut and encoded 2026-09-14 at the product owner's direction for the homepage "Who are we and what we do" section; silent, decorative, plays once and stops at fourteen seconds; the captions are the prior site's lines and are not treated as published copy |
| S-186 | Conceptual graphic `graphics/home/supply-hall-greyscale-v1.jpg` (a fulfilment aisle of plain cartons under clerestory light) | A (generated) | Gamma photo mode, 2026-09-14, monochrome brief, neutral greyscale at 1600×900; the homepage "Who are we and what we do" picture; conceptual, never presented as operational photography; no person, text or logo |
| S-185 | Rendering of the expansion-strategy document cover in `public/lsh/graphics/investors/` (title, date of August 25, 2026, and the three approved operating figures) | A (supplied by the product owner) | Supplied 2026-09-14; resized to 800 px wide and saved as JPEG; a rendering of the cover only, nothing from inside the document, which stays available on request; registered in `graphics.ts` with the standard conceptual provenance |
| S-184 | Conceptual graphic `graphics/connected-care/consultation-desk-greyscale-v1.jpg` (consultation desk with a tablet, a blood-pressure monitor, a sealed carton and a pen) | A (generated) | Gamma photo mode, 2026-09-13, monochrome brief, neutral greyscale at 1600×900; the Connected Care Vision hero; conceptual, never presented as operational photography; no person, text, vials or laboratory equipment |
| S-181 | Isometric supplies illustration in `public/lsh/graphics/pharmacy/` for the Pharmacy Solutions hero (a bathroom scale, a blood-pressure monitor with its cuff, an organizer case and two sealed pouches) | A (supplied by the product owner) | Supplied 2026-09-13; trimmed, squared to 960×960 and saved as a palette PNG; conceptual render, not a photograph; no person, medication or real product; registered in `graphics.ts` with the standard conceptual provenance |
| S-182 | Conceptual graphic `graphics/pharmacy/injection-accessories-greyscale-v1.jpg` (plain cartons, blank sealed packets and a capped pen needle) | A (generated) | Gamma photo mode, 2026-09-13, monochrome brief, neutral greyscale at 1600×900; the injection-accessories tile on Pharmacy Solutions; conceptual, never presented as operational photography; no packaging text, no medication |
| S-183 | Conceptual graphic `graphics/pharmacy/supply-organization-greyscale-v1.jpg` (open organizer case with gauze, a sealed pouch and a plain carton) | A (generated) | Gamma photo mode, 2026-09-13, monochrome brief, neutral greyscale at 1600×900; the supply-organization tile on Pharmacy Solutions; conceptual, never presented as operational photography |
| S-180 | Isometric clinic-project illustration in `public/lsh/graphics/clinic-solutions/` for the Clinic Solutions router (a clinic model on a floor plan with drawing tools and finish samples); the router's other two cards reuse the investor-page renders S-177 covers | A (supplied by the product owner) | Supplied 2026-09-13; resized to 1440×960 and saved as JPEG; conceptual render, not a photograph; no person, real project, premises or product; registered in `graphics.ts` with the standard conceptual provenance |
| S-179 | Three isometric illustrations in `public/lsh/graphics/investors/` for the technology steps (product record cards beside a database; a chart panel with a magnifier; an order list beside a calendar) | A (supplied by the product owner) | Supplied 2026-09-13; resized to 960×960 and saved as JPEG; conceptual renders, not photographs; no person, real system, product or order; registered in `graphics.ts` with the standard conceptual provenance |
| S-166 | Conceptual Metabolic Health hero still life (generic storage tray, organiser, neutral containers and planning forms) | A (generated) | Manus image generation, commissioned 2026-09-11 for `/metabolic-health`; dark editorial still life with LifeSupply red edge lighting, served from the recorded CDN URL in `metabolic-visuals.tsx`. Decorative only, with empty alt text and no visible embedded copy. It depicts no person, medication, injectable device, prescription, treatment, product label, clinical procedure, or confirmed kit; it must never imply an available product, a diagnosis, or a clinical recommendation. |
